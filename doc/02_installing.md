...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "1.67.1055"}}}' -m kaocha.runner --test-help
```
...
{:deps { ,,, }
 :aliases 
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.67.1055"}}
...
{:deps { ,,, }
 ...
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.67.1055"}}
         :exec-fn kaocha.runner/exec-fn
         :exec-args {}}
 :watch-test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.67.1055"}}
         :exec-fn kaocha.runner/exec-fn
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:kaocha {:dependencies [[lambdaisland/kaocha "1.67.1055"]]}}
