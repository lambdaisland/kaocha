...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "0.0-111"}}}' -m kaocha.runner --test-help
```
...
{:deps { ,,, }
 :aliases
 {:test {:deps {lambdaisland/kaocha {:mvn/version "0.0-111"}}}}}
```
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:kaocha {:dependencies [[lambdaisland/kaocha "0.0-111"]]}}
