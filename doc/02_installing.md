...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "1.85.1342"}}}' -m kaocha.runner --test-help
```
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:dev {:dependencies [,,, [lambdaisland/kaocha "1.85.1342"]]}}
...
```clojure
{:paths ["src" "test"]
 :deps {lambdaisland/kaocha {:mvn/version "1.85.1342"}}}
