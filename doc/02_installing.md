...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "1.81.1290"}}}' -m kaocha.runner --test-help
```
...
{:deps { ,,, }
 ...
 {:test {:main-opts ["-m" "kaocha.runner"]
         :extra-deps {lambdaisland/kaocha {:mvn/version "1.81.1290"}}}}}
```
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:dev {:dependencies [,,, [lambdaisland/kaocha "1.81.1290"]]}}
