...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "1.80.1274"}}}' -m kaocha.runner --test-help
```
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:dev {:dependencies [,,, [lambdaisland/kaocha "1.80.1274"]]}}
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:kaocha {:dependencies [[lambdaisland/kaocha "1.80.1274"]]}}
...
```clojure
{:paths ["src" "test"]
 :deps {lambdaisland/kaocha {:mvn/version "1.80.1274"}}}
