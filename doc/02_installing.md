...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "1.0.669"}}}' -m kaocha.runner --test-help
```
...
{:deps { ,,, }
 :aliases
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.0.669"}}}}}
```
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:kaocha {:dependencies [[lambdaisland/kaocha "1.0.669"]]}}
