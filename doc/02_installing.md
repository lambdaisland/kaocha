...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "0.0-340"}}}' -m kaocha.runner --test-help
```
...
{:deps { ,,, }
 :aliases
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "0.0-340"}}}}}
```
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:kaocha {:dependencies [[lambdaisland/kaocha "0.0-340"]]}}
