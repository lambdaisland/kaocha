...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "1.60.945"}}}' -m kaocha.runner --test-help
```
...
{:deps { ,,, }
 ...
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.60.945"}}
         :exec-fn kaocha.runner/exec-fn
         :exec-args {}}
 :watch-test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.60.945"}}
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:dev {:dependencies [,,, [lambdaisland/kaocha "1.60.945"]]}}
