...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "1.89.1380"}}}' -m kaocha.runner --test-help
```
...
{:deps { ,,, }
 :aliases 
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.89.1380"}}
...
{:deps { ,,, }
 ...
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.89.1380"}}
         :exec-fn kaocha.runner/exec-fn
         :exec-args {}}
 :watch-test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.89.1380"}}
         :exec-fn kaocha.runner/exec-fn
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:dev {:dependencies [,,, [lambdaisland/kaocha "1.89.1380"]]}}
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:kaocha {:dependencies [[lambdaisland/kaocha "1.89.1380"]]}}
...
```clojure
{:paths ["src" "test"]
 :deps {lambdaisland/kaocha {:mvn/version "1.89.1380"}}}
