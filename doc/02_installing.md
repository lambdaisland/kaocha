...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "1.74.1188"}}}' -m kaocha.runner --test-help
```
...
{:deps { ,,, }
 ...
 {:test {:main-opts ["-m" "kaocha.runner"]
         :extra-deps {lambdaisland/kaocha {:mvn/version "1.74.1188"}}}}}
```
...
{:deps { ,,, }
 :aliases 
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.74.1188"}}
...
{:deps { ,,, }
 ...
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.74.1188"}}
         :exec-fn kaocha.runner/exec-fn
         :exec-args {}}
 :watch-test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.74.1188"}}
         :exec-fn kaocha.runner/exec-fn
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:dev {:dependencies [,,, [lambdaisland/kaocha "1.74.1188"]]}}
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:kaocha {:dependencies [[lambdaisland/kaocha "1.74.1188"]]}}
